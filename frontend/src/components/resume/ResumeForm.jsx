    ...
    if (step === 1) {
        return (
            <div className='flex flex-col gap-3'>
                <Input label="Full Name" placeholder="Rahul Roy" onChange={(v) => setData({ ...data, name: v })} value={data.name} />

                <Input label="Email" placeholder="rahul@email.com" onChange={(v) => setData({ ...data, email: v })} value={data.email} />

                <Input label="Phone" placeholder="+91 9898989898" onChange={(v) => setData({ ...data, phone: v })} value={data.phone} />

                <Input label="Location" placeholder="Kolkata, WB" onChange={(v) => setData({ ...data, location: v })} value={data.location} />

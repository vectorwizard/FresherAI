  ...
  return (
    <div className='bg-white text-[#0A0A0A] font-sans min-h-screen overflow-x-hidden'>
      ...
      <section className="relative pt-20 pb-14 overflow-hidden bg-[#F8F9FA]">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} whileHover={{ y: -10, scale: 1.02 }} transition={{ duration: 0.6, delay: 0.3 }} className="mt-10 rounded-lg overflow-hidden shadow-[0_0_60px_rgba(0,0,0,0.06)] max-w-2xl mx-auto">
